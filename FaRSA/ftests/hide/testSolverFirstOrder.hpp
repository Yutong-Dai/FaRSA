...
#ifndef __TESTSOLVERFIRSTORDER_HPP__
#define __TESTSOLVERFIRSTORDER_HPP__
...
int testSolverFirstOrderImplementation(int option)
{
    // Initialize output
    int result = 0;
    ...
    std::shared_ptr<LinearRegressionLoss> f(new LinearRegressionLoss((char*)"./data/lsMatrix.txt", M_COORDINATE_LIST,
...
}  // end testSolverFirstOrderImplementation

#endif /* __TESTSOLVERFIRSTORDER_HPP__ */
